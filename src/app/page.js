...
export default function Home() {
  ...
  return (
    <>
      <section>
        <div className="h-[300px] sm:h-[350px] md:h-[450px] relative">
          <img
            className="h-full w-full object-cover"
            src="https://helloblen.com/images/blog/IB_Diploma_Programme/blen-encrypting-your-future-with-your-ibdp-computer-science-header.jpg"
            alt="Background"
          />
        </div>
      </section>
  ...
  <div className="my-[50px] w-[270px] h-[200px] bg-yellow-300 text-white font-bold rounded-md flex flex-col items-center justify-center transform transition-transform duration-300 hover:scale-110">
    ...
    <p className="flex items-center gap-1 text-lg">Enroll now <FaArrowRight /></p>
      ...
      <section className="container mx-auto">
        ...
        <div className="grid grid-rows-3 grid-cols-3 justify-items-stretch items-stretch py-12 ">
